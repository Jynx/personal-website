        ...
        <Container className="mt-9">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
              I’m Steve, a software engineer and gamer based in Chicago. I
              have over nine years of experience developing software platforms
              and large-scale web applications, having both led and been
              a member of teams that delivered software built to support video
